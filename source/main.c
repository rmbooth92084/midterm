...
typedef enum detect_eq_states { DEQInit,detect,wait                                    } detect_eq_states;
typedef enum detect_max_amp_states { DMAInit,                               } detect_max_amp_states;
typedef enum detect_zc_states { DZCInit, dir,test,test2                                   } detect_zc_states;
typedef enum transmit_states {TInit,                                        } transmit_states;

/* shared variables --- fill in as needed */

unsigned char tempB = 0x00;
unsigned char quake = 0;
